        ...
        <div ref='resume' :style="{ fontFamily: resumeData.style.fontFamliy }"  class='resume-item'>
            ...
            <div class='resume-body'>
                <div
                  ...
                  <div :style="'background: ' + resumeData.style.color" class='msg-title'><span >{{item.text}}</span><i :style="'background: ' + resumeData.style.color" class='msg-border' /><i :style="'border-color:' + baseColor + ' transparent transparent'" class='msg-triangle'/></div>
                  <div 
                   :style="{
                ...
                <div
                  ...
                  draggable=true
                  class='resume-msg-item' v-for='(item,index) in resumeData.content.otherContent' :key='index+100'>border-color:red transparent transparent
                  <div :style="'background: ' + resumeData.style.color"  class='msg-title'><span >{{item.text}}</span><i :style="'background: ' + resumeData.style.color" class='msg-border' /><i :style="'border-color:' + baseColor + ' transparent transparent'" class='msg-triangle'/></div>
                  <div 
                  :style="{
                      borderTop: '2px solid ' + resumeData.style.color,
