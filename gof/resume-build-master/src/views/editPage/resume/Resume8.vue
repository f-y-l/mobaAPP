<template>
    <object class = "resume">
        <div ref='resume'  :style="{ fontFamily: resumeData.style.fontFamliy }"  class='resume-item'>
            <div  :style="'background: ' + resumeData.style.color" class='resume-head'>
            ...
            <div class='resume-body'>
                <div
                  ...
                  draggable=true  
                  class='resume-msg-item' v-for='(item,index) in resumeData.content.mainContent' :key='index+100'>
                  <div :style="'color: ' + resumeData.style.color" class='msg-title'><span >{{item.text}}</span><i :style="'background: ' + resumeData.style.color" :class='"fa fa-"+item.url' /></div>
                  <div 
                   :style="{
                      borderTop: '2px solid ' + resumeData.style.color,
                      borderLeft: '2px solid ' + resumeData.style.color,
                      paddingTop:resumeData.style.moduleSize,
                      paddingBottom: resumeData.style.moduleSize
                     }"
                  class='msg-body-wrapper'>
                    ...
                    <div class='msg-body1' v-else-if='item.type === 1'>
                        <div class='msg-body1-item' v-for='(item1,index1) in item.data' :key="index1">
                            ...
                            <div class='body-title-item body-left'>{{item1.time}}</div>
                    ...
                    <div :style="{fontSize: resumeData.style.fontSize}" class='msg-body2' v-else-if='item.type === 2'>
                        <div class='msg-body2-item' v-for='(item1,index1) in item.data' :key='index1'>
                            <span class='time body-left'>{{item1.time}}</span>
                ...
                <div
                  ...
                  draggable=true
                  class='resume-msg-item' v-for='(item,index) in resumeData.content.otherContent' :key='index'>
                  <div :style="'color: ' + resumeData.style.color" class='msg-title'><span >{{item.text}}</span><i :style="'background: ' + resumeData.style.color" :class='"fa fa-"+item.url' /></div>
                  <div 
                  :style="{
                      borderTop: '2px solid ' + resumeData.style.color,
